...
function Academic() {
  return (
    <Section>
        <h2 className="text-4xl font-bold mb-10 text-center">Academic <span className="text-blue-400"> Research .</span></h2>
        {/* <div className="grid grid-cols-1 md:grid-cols-3 gap-6"> */}
            <div className=" flex flex-col p-8 rounded-xl bg-black/20 border-2 border-white/10 backdrop-blur-md shadow-xl hover:bg-black/40 hover:border-white/20 transition-all duration-300 border-b-4 border-r-4 ">
              <div key={""} className="flex items-center justify-baseline ">
                <div className="font-semibold text-3xl"> <span className="text-blue-400"> 2025 </span> Eighth International Conference on <span className="text-blue-400">
